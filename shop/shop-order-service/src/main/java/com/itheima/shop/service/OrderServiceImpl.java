...
public class OrderServiceImpl implements IOrderService {
    ...
    private Long savePreOrder(TradeOrder order) {
        ...
        //4.核算订单总金额是否合法
       BigDecimal   orederAmount = order.getGoodsPrice().multiply(new BigDecimal(order.getGoodsNumber()));
       orederAmount.add(shippingFee);
       if(order.getOrderAmount().compareTo(orederAmount)!=0){
